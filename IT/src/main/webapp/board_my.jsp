...
<jsp:useBean id="test" class="teamproject.Board"/>
	...
	<div class="postWrap"><!-- 전체div -->
	    ...
	    <div class="titleWrap">
		    ...
		    <div class="postIcon">
		    	...
		    	<a href="boardWrite.jsp"><img src="imgs/board/plus_icon.png"></a>
	    ...
	    <!-- 이미지리스트1 -->
	 	<div class="imglistWrap" id="list">
		    <div class="imglist">
			    <div>
				    <a href="boardView_my.jsp" class="popup"><img src="imgs/board/aaa1.jpg"></a>
				    <div>
					    <div class="likeBox">
			    	...
			    	<div>
				    <a href="boardView.jsp" class="popup"><img src="imgs/board/aaa10.jpg"></a>
				    <div>
					    <div class="likeBox">
					    <div>좋아요 n개</div>&nbsp;&nbsp;&nbsp;&nbsp;<div>댓글 n개</div>
					    </div>
			    	...
			    	<div>
				    <a href="boardView_my.jsp" class="popup"><img src="imgs/board/aaa12.jpg"></a>
				    <div>
					    <div class="likeBox">
					    <div>좋아요 n개</div>&nbsp;&nbsp;&nbsp;&nbsp;<div>댓글 n개</div>
					    </div>
